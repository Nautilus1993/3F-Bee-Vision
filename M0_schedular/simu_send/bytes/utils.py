...
def format_file_hex(file_path):
    with open(file_path, 'rb') as file:
        bytes_string = file.read()
        print(format_bytes_stream(bytes_string))
...
def main():
    ...
    #     send_some_shit(29)
    #     time.sleep(1)
    format_file_hex("/home/ywang/Documents/3F-Bee-Vision/M0_schedular/communication/image/image_976_400_2250.bmp")
